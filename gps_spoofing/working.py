"""
Module to determine working time
"""
import datetime


def is_working(person):
    """
    Checks if a person is currently working, based on the times given in the config file. If working, it modifies the
    current GPS.
    ...
    started = person['Mobile devices'][0]['working time']
