"""
Module to determine weekend time
"""
import datetime
...
def is_weekend():
    """
    Checks if today is weekend or not based on the clock of the PC.

    :return: True/False if it is weekend
    """
...
def weekend(person):
    ...
    started = person['Mobile devices'][0]['weekend activity time']
