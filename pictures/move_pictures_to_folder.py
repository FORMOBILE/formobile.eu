...
def move_pictures_to_folder(from_folder: str, to_folder: str, amount: int) -> None:
    """
    Moves a given amount of random pictures from from_folder to to_folder to avoid duplicates.
